...
const Header = () => {
  ...
  return (
    <div className="flex items-center justify-between py-4 sticky top-0 left-0 ">
      {/* logo start */}
      ...
      {/* toggle button */}
      <ToggleButton onClick={() => setToggle((tgl) => !tgl)} toggle={toggle} />
      ...
      >
        <div onClick={()=>setToggle((tgl) => !tgl)} className="flex-1 h-full"></div>
